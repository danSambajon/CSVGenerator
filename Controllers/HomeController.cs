...
namespace CSVGenerator.Controllers
{
    public class HomeController : Controller
    {
        private readonly Microsoft.Extensions.Hosting.IHostApplicationLifetime _appLifetime;

        public HomeController(ILogger<HomeController> logger, Microsoft.Extensions.Hosting.IHostApplicationLifetime appLifetime)
        {
        ...
        public IActionResult StartGenerate()
        {
            ...
            return RedirectToAction("GetRows", "Home");
        }

        //This function creates CSV for fuels lubes and safedrops
